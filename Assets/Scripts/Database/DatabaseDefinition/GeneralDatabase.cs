...
namespace GamePlaySystem.Database
{
    ...
    public class GeneralDataItem
    {
        ...
        [ShowIf(nameof(IsUpgradable)), VerticalGroup("Additional"), HorizontalGroup("Additional/Exp"),] [CanBeNull]
    ...
    public abstract class GeneralDatabase<TDataItem> : ScriptableObject, IIDBasedDatabase<TDataItem>
        where TDataItem : GeneralDataItem
    {
        public int idStart;
        ...
        private void ReassignAllIDs()
        {
            ...
            idEnd = Items.Count > 0 ? idStart + Items.Count - 1 : idStart;
        }
