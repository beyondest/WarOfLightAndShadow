...
{
    public struct ArmyGroupRealTimeInfo
    {
    ...
    {
         private NativeList<ArmyGroupRealTimeInfo> _infos;
        private bool _initEvents;

        protected override void OnCreate()
        {
            RequireForUpdate<MainGamingTag>();
            _infos = new NativeList<ArmyGroupRealTimeInfo>(Allocator.Persistent);
        }
        ...
        private void UpdateSelectedInfos(ArmyGroupSelectionData selectionData)
        {
            ...
            {
                _infos.Add(new ArmyGroupRealTimeInfo
                {
                    Entity = entity,
