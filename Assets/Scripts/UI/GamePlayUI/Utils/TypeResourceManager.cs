...
namespace SparFlame.UI.GamePlay
{
    ...
    public class TypeResourceManager<TEnum, TData, TEntityPrefabData> : MonoBehaviour
        where TEnum : Enum
        where TData : GeneralDataItem
        where TEntityPrefabData : unmanaged, IEntityPrefabData<TEnum>
    {
        [SerializeField] private float loadResourceTimeOutSeconds = 5;
        ...
        public SpriteEntityInfo GetInfo(TEnum type, int globalIdx)
        {
        ...
        {
            StartCoroutine(LoadSpriteEntityInfoNextFrame());
        }
        ...
        private IEnumerator LoadSpriteEntityInfoNextFrame()
        {
