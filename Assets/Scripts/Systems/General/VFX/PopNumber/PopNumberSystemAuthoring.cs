...
namespace SparFlame.Systems.General.VFX
{
    public class PopNumberSystemAuthoring : MonoBehaviour
    {
        ...
        [Header("PopNumber Animation Config")] [Tooltip("Control the fade vertical direction of the pop number")]
        public float verticalMovementOffset = 2f;

        [Tooltip("Fade out time")] public float movementTime = 2f;
        ...
        [Tooltip(
            "The only reason to adjust this, is when camera has offset in y or z axis and that will cause number not horizontal")]
