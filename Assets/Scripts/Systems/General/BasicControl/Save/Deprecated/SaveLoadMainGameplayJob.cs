...
//             in ArmyGroupPathVisualizeData armyGroupPathVisualizeData, in DynamicBuffer<WaypointBuffer> waypointBuffer,
...
//             });
//             ECB.AddComponent(index, saveEntity, armyGroupPathVisualizeData);
//
...
//             {
//                 cityGlobalIndex = PrefabIdLookup[lastPassingByCity.City].value,
//             });
//
...
//                 {
//                     globalId = armyGroupUnit.PrefabId,
//                     tmpId = armyGroupUnit.SingleId,
//                 });
//             }
//
...
//             in NavAgentComponent navAgentComponent, in ArmyGroupCalculatePathData armyGroupCalculatePathData,
//             in SeCalculationEnable calculationEnable, in ArmyGroupPathVisualizeData armyGroupPathVisualizeData,
...
//             ECB.SetComponent(index, armyGroup, armyGroupPathVisualizeData);
//
//             
//             foreach (var waypoint in waypointBuffer)
//             {
...
//                 {
//                     Unit = Entity.Null,
//                     PrefabId = armyGroupUnit.globalId,
//                     SingleId = armyGroupUnit.tmpId
//                 });
//             }
//
...
//         {
//             ECB.DestroyEntity(index, selfEntity);
//             var prefab = GlobalIdxToPrefabs[prefabId.value];
//
