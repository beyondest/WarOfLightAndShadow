...
//             in LocalTransform transform, in PrefabId prefabId,
...
//             });
//             ECB.AddComponent(index, saveEntity, new SePrefabId { value = prefabId.value });
...
//                         {
//                             unitTmpId = GlobalSingleIdLookup[garrisonEntity.Unit].value,
//                             id = garrisonEntity.PrefabId
//                         });
//                     }
//
//                     ECB.AddComponent(index, saveEntity,
...
//                             unitGlobalId = conjuringData.PrefabId
//                         });
//                     }
//                 }
//
...
//                     {
//                         PrefabId = seConjuringData.unitGlobalId,
...
//                     {
//                         PrefabId = seGarrison.id,
//                         Unit = TmpIdxToInstances[seGarrison.unitTmpId]
//                     });
//                 }
//
...
//             {
//                 var unit = units[i];
//                 unit.Unit = TmpIdxToInstances[unit.SingleId];
//                 units[i] = unit;
//             }
//         }
//     }
