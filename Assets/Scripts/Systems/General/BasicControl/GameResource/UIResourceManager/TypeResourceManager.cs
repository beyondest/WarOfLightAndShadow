...
namespace SparFlame.Systems.General.BasicControl
{
    ...
    public class TypeResourceManager<TEnum, TData, TEntityPrefabData> : MonoBehaviour,IResourceManager
        where TEnum : Enum
        ...
        where TEntityPrefabData : unmanaged, IEntityPrefabData<TEnum>
    {
        ...
        // Internal Data
        protected readonly ResourceLoadingUtils.AddressableResourceGroup ResourceGroup = new();
        ...
        private IEnumerator LoadSpriteEntityInfo()
        {
            ...
            foreach (var dataItem in databaseSo.Items)
            {
                ...
                var handle = ResourceLoadingUtils.LoadAssetRefAsync<Sprite>(dataItem.sprite2D, sprite =>
                {
