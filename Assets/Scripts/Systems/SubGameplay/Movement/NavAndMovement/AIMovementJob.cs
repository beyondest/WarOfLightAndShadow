...
//             navAgent.targetPosition = new float3(movableData.TargetCenterPos.x, movableData.TargetCenterPos.y, movableData.TargetCenterPos.z);
...
//             var curPosY0 = new float3(transform.Position.x, transform.Position.y, transform.Position.z);
...
//                     {
//                         x = movableData.TargetColliderShape.x,
//                         y = 1f,
//                         z = movableData.TargetColliderShape.y
//                     };
//                     var curDisSqPointToRect =
//                         MovementUtils.DistanceSqPointToRect(targetCenterPos2D, movableData.TargetColliderShape,
//                             curPos2D);
...
//                                 movableData.TargetColliderShape, endPos2D);
