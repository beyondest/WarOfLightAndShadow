...
namespace SparFlame.Systems.SubGameplay.Interact
{
    ...
    public partial struct CheckStatChangeRequest : IJobEntity
    {
            ...
            int index, int absAmount)
        {
            switch (request.Type)
            {
                ...
                case StatChangeType.Harvest:
                    ...
                    // StatUtils.GenerateHarvestResourceRequest(request, request.InteractorSubGameplayGeneralAttr,
                    //     resourceAttr,
                    //     index, ECB, absAmount);
                    StatUtils.GeneratePopNumberRequest(ref TransformLookup, request,
                        request.InteractorSubGameplayGeneralAttr,
            ...
            in SubGameplayGeneralAttr interacteeAttr)
        {
            ...
            {
                case BaseTag.Units:
                    StatUtils.GenerateGarrisonUnitDieRequest(request.Interactee, index,
                ...
                case BaseTag.Buildings:
                    ...
                    else
                    {
                        ...
                        if (GeneratingTagLookup.HasComponent(request.Interactee))
                        {
                            ...
                            StatUtils.GenerateDecreaseGenerateSpeedRequest(index, CurrentCity,
                                generateAttr.GenerateResourceType,
