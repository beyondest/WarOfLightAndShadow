...
{
    public class NavMeshControllerMainGameplay : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _updateNavMeshRequest = _em.CreateEntityQuery(typeof(UpdateNavMeshRequest), typeof(MainGameplayEntityTag));
        }
