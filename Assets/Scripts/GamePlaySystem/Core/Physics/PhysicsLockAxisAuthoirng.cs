...
public class PhysicsLockAxisAuthoring : MonoBehaviour
{
    [Header("Physics Mass")]
    ...
    class Baker : Baker<PhysicsLockAxisAuthoring>
    {
        ...
        public override void Bake(PhysicsLockAxisAuthoring authoring)
        {
            if (HasPhysics())
            {
