...
namespace SparFlame.GamePlaySystem.Building
{
    ...
    [CreateAssetMenu(fileName = "BuildingDatabase", menuName = "GameData/BuildingDatabase2", order = 0)]
    public class BuildingDatabaseSo2 : ScriptableObject
    {
        
        public List<BuildingData2> buildingsData;
    ...
    [Serializable]
    public class BuildingData2 : GeneralDS.DatabaseItemData
    {
        [Header("BuildingConfig")]
