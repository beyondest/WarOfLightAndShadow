...
{
    // public class SightAttributesDef : MonoBehaviour
    // {
    //     public GameObject sightPrefab;
    //     private class Baker: Baker<SightAttributesDef>
    //     {
    //         public override void Bake(SightAttributesDef def)
    //         {
    //             var entity = GetEntity(TransformUsageFlags.Dynamic);
    //             AddBuffer<InsightTarget>(entity);
    //             AddComponent(entity, new GenerateSightRequest
    //             {
    //                 SightPrefab = GetEntity(def.sightPrefab, TransformUsageFlags.Dynamic),
    //             });
    //         }
    //     }
    // }
